...
Portions of this project (firmware logic, backend architecture, frontend components, documentation, and debugging) were developed with the assistance of **Claude Code** (powered by Claude Sonnet), an AI programming tool by Anthropic. AI assistance was used throughout the development cycle in compliance with the Cornerstone of Engineering course policy and Project 2 policy requiring disclosure of generative AI use.
